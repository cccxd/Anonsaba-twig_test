...
if (file_exists('config.php')) {
  $installing = true;
	...
	if (KU_RANDOMSEED!="ENTER RANDOM LETTERS/NUMBERS HERE"&&KU_RANDOMSEED!=""&&KU_SALT!="ENTER RANDOM LETTERS/NUMBERS HERE"&&KU_SALT!="") {
		...
		echo 'Please enter a random string into the <strong>KU_RANDOMSEED</strong> and <strong>KU_SALT</strong> value.';
	}
} else {
